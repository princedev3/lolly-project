...
export const generateOrderPdf = async (
  ...
  const filePath = path.join(tempDir, `order-${orderDetails.id}.pdf`);
...
// // generate-pdf.ts
// import chromium from "@sparticuz/chromium"; // Default import
// import puppeteer from "puppeteer-core";
// import fs from "fs/promises";
// import path from "path";
// import { Order } from "@prisma/client";
...
// ): Promise<string> => {
//   const browser = await puppeteer.launch({
//     args: chromium.args, // Using default import's args
//     defaultViewport: chromium.defaultViewport, // Using default import's defaultViewport
//     executablePath:
//       process.env.NODE_ENV === "production"
//         ? await chromium.executablePath() // Using default import's executablePath
//         : "/usr/bin/google-chrome",
//     headless: chromium.headless, // Using default import's headless
//   });

//   const page = await browser.newPage();

//   // Example HTML for the PDF
...
//         <p>Thank you for your order with Lolly Collections!</p>
//       </body>
//     </html>
//   `);
...
//   const fileName = `order-${orderDetails.id}.pdf`;
